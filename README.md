...
เวอร์ชัน 2.1 แก้คำสั่งเปลี่ยนเครื่องแบบกลุ่ม โดยส่งทีละเครื่องเป็นคิว เนื่องจาก VMOS ประมวลผล `replacePad` ได้ครั้งละหนึ่งเครื่องในบัญชีชุดนี้

เวอร์ชัน 2.2 แก้การเลือกทั้งหมดในกลุ่มไม่ให้รวมรายการเก่า เพิ่มปุ่มหยุดคิว และหยุดอัตโนมัติเมื่อเปลี่ยนเครื่องล้มเหลวติดต่อกัน 2 เครื่อง
